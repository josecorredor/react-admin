    ...
    return (
        <Wrapper>
            <form onSubmit={submit}>
                <div className="mb-3">
                    <label>Week</label>
                    <select className="form-control" required onChange={e => setIdWeek(e.target.value)}>
                ...
                <div className="mb-3">
                    ...
                    <select className="form-control" required onChange={e => setIdClassification(e.target.value)}>
                    <option value={''}>Please select an option -</option>    
                ...
                <div className="mb-3">
                    ...
                    <input className="form-control" required onChange={e => setDetail(e.target.value)}></input>
                </div>
                <div className="mb-3">
                    <label>Subclassification</label>
                    <select className="form-control" required onChange={e => setIdTxType(e.target.value)}>
                    <option value={''}>Please select an option -</option>    
                ...
                <div className="mb-3">
                    <label>User</label>
                    <select className="form-control" required onChange={e => setIdPerson(e.target.value)}>
                    <option value={''}>Please select an option -</option>    
                    {users.map((u: User)=> {
                        return (
                ...
                <div className="mb-3">
                    <label>Total</label>
                    <input type="number" className="form-control" required onChange={e => setValue(e.target.value)}></input>
                </div>
